...
import org.smartgresiter.jhpiego.interactor.LoginInteractor;
import org.smartgresiter.jhpiego.util.ImageLoaderRequest;
...
public class LoginPresenter extends BaseLoginPresenter implements BaseLoginContract.Presenter {
    ...
    public void processViewCustomizations() {
        try {
            ...
            ViewConfiguration loginView = JhpiegoApplication.getJsonSpecHelper().getConfigurableView(jsonString);
