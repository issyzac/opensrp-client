    ...
    private void saveRegistration(Pair<Client, Event> pair, String jsonString) {
        ...
        try {
            ...
            if (baseClient != null) {
                ...
                JhpiegoRepository pathRepository = new JhpiegoRepository(JhpiegoApplication.getInstance().getApplicationContext(), JhpiegoApplication.getInstance().getContext());
                EventClientRepository eventClientRepository = new EventClientRepository(pathRepository);
                JSONObject clientJson = eventClientRepository.getClient(JhpiegoApplication.getInstance().getRepository().getReadableDatabase(), baseClient.getBaseEntityId());
